...
async def transcribe_meeting(
    ...
    # Whisper returns full language names ("Portuguese") in verbose_json, but our schema
    # validator (ACCEPTED_LANGUAGE_CODES) expects ISO 639-1 codes ("pt"). Normalize here.
    ...
    lang_lower = (detected_language or "").lower().strip()
    detected_language = _LANGUAGE_NAME_TO_CODE.get(lang_lower, lang_lower if len(lang_lower) <= 3 else "en")
